...
@section('Titulo','Fisioterapeuta Especifica'.$variable->nombre)
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Perfil de fisioterapeuta</h5>
              </div>
              <div class="card-body">
                <form>
                  <div class="row">
                        ...
                        <div class="col-md-4 pr-1">
                          <div class="form-group">
                            <label>Cedula</label>
                            <input type="text" class="form-control" disabled="" placeholder="Company" value="{{$variable->cedula}}" readonly=" ">
                          </div>
                        </div>
                        <div class="col-md-4 pr-1">
                          <div class="form-group">
                        ...
                        <div class="col-md-4 pr-1">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled="" placeholder="Company" value="{{$variable->telefono}}" readonly=" ">
                          </div>
                        </div>
                        <div class="col-md-4 pr-1">
                          <div class="form-group">
                                ...
                                <ol>
                                    @foreach ($mezcla as  $combinacion)
                                        @foreach ($especialidades as  $especialidad)
                                            @if($combinacion->especialidad_id == $especialidad->id)
            ...
            <div class="card card-user">
              ...
              <div class="card-body">
                <div class="author">
                    ...
                    <a href="{{route('fisioterapeuta.index')}}" class="btn btn-outline-primary"><i class="fas fa-reply"></i> Volver al inicio</a>
                    <a href="{{route('fisioterapeuta.cargar',$variable)}}" class="btn btn-outline-success"><i class="fas fa-upload"></i> Cargar especialidades</a><br>
                    <a href="{{route('fisioterapeuta.edit',$variable)}}" class="btn btn-outline-warning"><i class="fas fa-edit"></i> Editar</a>
                    
                    <form action="{{route('fisioterapeuta.destroy',$variable)}}" method="post" >
                        @csrf
                        @method('delete')
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>¿Estas seguro de que quieres eliminar este fisioterapeuta?</p>
                                    </div>
